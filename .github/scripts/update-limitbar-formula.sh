...
darwin_amd64_name="limitbar-darwin-x86_64-${tag}.tar.gz"
darwin_arm64_name="limitbar-darwin-aarch64-${tag}.tar.gz"
linux_amd64_name="limitbar-linux-x86_64-${tag}.tar.gz"
linux_arm64_name="limitbar-linux-aarch64-${tag}.tar.gz"
...
echo "Updated Formula/limitbar.rb to ${version}"
